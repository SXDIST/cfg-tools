...
export const messages: Record<Locale, Record<string, MessageValue>> = {
  ru: {
    ...
    cfgmods_group_identity_title: "Основная информация",
    cfgmods_group_identity_desc: "Название, автор, версия и служебные поля мода.",
    cfgmods_group_presentation_title: "Отображение",
    cfgmods_group_presentation_desc: "Картинка, подсказки, описание и видимость в интерфейсе.",
    cfgmods_group_scripts_title: "Скрипты и defs",
    cfgmods_group_scripts_desc: "Inputs, зависимости, imageSets и скриптовые модули.",
    cfgmods_optional_params_title: "Дополнительные параметры CfgMods",
    cfgmods_optional_params_desc:
      "Добавьте несколько скрытых полей CfgMods без прокрутки всей секции.",
    cfgmods_add_params: "Добавить параметры CfgMods",
    cfgmods_add_params_title: "Добавление параметров CfgMods",
    cfgmods_add_params_desc:
      "Выберите дополнительные поля CfgMods. Используйте поиск или группы.",
    cfgmods_search_placeholder: "Поиск полей CfgMods...",
    cfgmods_available_count: ({ count }) => `Доступно: ${count}`,
    cfgmods_picker_group_root: "Метаданные мода",
    cfgmods_picker_group_defs_imagesets: "Image sets",
    cfgmods_picker_group_game_script: "Game script module",
    cfgmods_picker_group_world_script: "World script module",
    cfgmods_picker_group_mission_script: "Mission script module",
    cfgmods_picker_group_other: "Другое",
  ...
  en: {
    ...
    cfgmods_group_identity_title: "Main information",
    cfgmods_group_identity_desc: "Mod name, author, version, and technical fields.",
    cfgmods_group_presentation_title: "Presentation",
    cfgmods_group_presentation_desc: "Image, tooltips, overview, and UI visibility.",
    cfgmods_group_scripts_title: "Scripts and defs",
    cfgmods_group_scripts_desc: "Inputs, dependencies, imageSets, and script modules.",
    cfgmods_optional_params_title: "Optional CfgMods parameters",
    cfgmods_optional_params_desc:
      "Add several hidden CfgMods fields without scrolling through the whole section.",
    cfgmods_add_params: "Add CfgMods parameters",
    cfgmods_add_params_title: "Add CfgMods parameters",
    cfgmods_add_params_desc:
      "Choose optional CfgMods fields. Use search or groups to find what you need.",
    cfgmods_search_placeholder: "Search CfgMods fields...",
    cfgmods_available_count: ({ count }) => `Available: ${count}`,
    cfgmods_picker_group_root: "Mod metadata",
    cfgmods_picker_group_defs_imagesets: "Image sets",
    cfgmods_picker_group_game_script: "Game script module",
    cfgmods_picker_group_world_script: "World script module",
    cfgmods_picker_group_mission_script: "Mission script module",
    cfgmods_picker_group_other: "Other",
